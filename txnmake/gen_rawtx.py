...
from txn_make.gen_keypair import sizeof
...
class Output:
    ...
    def __init__(self, txid, index):
        ...
        # We'll fetch it later with the function below
...
class Transaction:
    ...
    def serialize(self):
        ...
        """
        # get the inputs for the transactions
        ...
        # get the outputs for the transactions
